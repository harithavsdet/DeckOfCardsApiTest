...
/**
 * This automation api for testing for deck of cards API.
 */
public class DeckOfCardsAPITest {
    ...
    public void testCreateNewDeck(){
        given()
                .when()
                .get(DECK_OF_API_ROOT_URL+"/api/deck/new")
                .then()
                .assertThat()
    ...
    public void testCreateNewDeckWithShuffle(){
        given()
                .when()
                .get(DECK_OF_API_ROOT_URL+"/api/deck/new/shuffle")
                .then()
                .assertThat()
                .contentType("application/json")
                .statusCode(200)
    ...
    /**
     * Testing for adding jockers to a new deck without shuffle
     */
    @Test
    public void testAddingJockersInNewDeck(){
        given()
                .when()
                .param("jokers_enabled", true)
                .get(DECK_OF_API_ROOT_URL+"/api/deck/new")
                .then()
                .assertThat()
                .contentType("application/json")
    ...
    /**
     * Testing for adding jockers to new Deck with shuffle
     */
    @Test
    ...
    public void testDrawAOneCardFromDeck(){
        ...
        given()
                ...
                .get(DECK_OF_API_ROOT_URL+"/api/deck/{deck_id}/draw/")
                .then()
                .statusCode(200)
                .body("success", equalTo(true))
                .body("deck_id", equalTo(deckId))
                .body("cards[0].code", equalTo("AS"))
                .body("cards[0].value", equalTo("ACE"))
                .body("cards[0].suit", equalTo("SPADES"))
    ...
    public void testDrawMultipleCardsFromNewDeck(){
        ...
        given()
                ...
                .body("cards[0].value", equalTo("ACE"))
                .body("cards[0].suit", equalTo("SPADES"))
                .body("cards[1].code", equalTo("2S"))
                .body("cards[1].value", equalTo("2"))
                .body("cards[1].suit", equalTo("SPADES"))
    ...
    public void testDrawAOneCardFromDeckWithShuffle(){
        ...
        given()
                ...
                .body("cards[0].code", notNullValue())
                .body("cards[0].value", notNullValue())
                .body("cards[0].suit", notNullValue())
                .body("remaining", equalTo(51));
    }
    ...
    public void testDrawMultipleCardsFromNewDeckWithShuffle(){
        ...
        given()
                ...
                .body("cards[0].value", notNullValue())
                .body("cards[0].suit", notNullValue())
                .body("cards[1].code", notNullValue())
                .body("cards[1].value", notNullValue())
                .body("cards[1].suit", notNullValue())
                .body("remaining", equalTo(50));
    }
